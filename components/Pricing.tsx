...
const Pricing = (props: Props) => {
  return (
    <section id="pricing" className="my-10 px-5">
        <section className="flex md:flex-row flex-col items-center space-y-10 md:space-y-0 md:space-x-10 justify-center">
            ...
            <Card className=" w-full sm:w-[400px]">
                ...
                <CardContent>
                    <p className="text-xl sm:text-3xl mb-3 font-extrabold"><del className="text-muted-foreground">₹8999</del>{" "}₹6999</p>
            ...
            <Card className="w-full sm:w-[400px]">
                ...
                <CardContent>
                <p className="text-xl sm:text-3xl mb-3 font-extrabold"><del className="text-muted-foreground">₹16999</del>{" "}₹13999</p>
                    <ul className="list-disc text-sm sm:text-base ">
        ...
        <section className="flex mt-5 space-y-2 items-center flex-col justify-center">
            <p className="italic text-muted-foreground text-center">Contact by clicking below, assured reply within 12 hours.</p>
